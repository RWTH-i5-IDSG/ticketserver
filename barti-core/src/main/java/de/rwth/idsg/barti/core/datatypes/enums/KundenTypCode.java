...
public enum KundenTypCode implements Data<KundenTypCode> {
    NICHT_SPEZIFIZIERT_UNBESTIMMT(0, "nicht spezifiziert/unbestimmt"),
    ERWACHSENER_VOLLZAHLER_JEDERMANN(1, "Erwachsener/Vollzahler/jedermann"),
    KIND(2, "Kind"),
    STUDENT(3, "Student"),
    ...
    KOSTENPFLICHTIGES_TIER(17, "Kostenpflichtiges Tier"),
    SCHUELER(19, "Schüler"),
    AZUBI(20, "Azubi"),
    SENIOR(25, "Senior"),
    RFU_CE_26(26, "RFU CE 26"),
    RFU_CE_27(27, "RFU CE 27"),
    RFU_CE_28(28, "RFU CE 28"),
    RFU_CE_29(29, "RFU CE 29"),
    RFU_CE_30(30, "RFU CE 30"),
    RFU_CE_31(31, "RFU CE 31"),
    RFU_CE_32(32, "RFU CE 32"),
    RFU_CE_33(33, "RFU CE 33"),
    RFU_CE_34(34, "RFU CE 34"),
    RFU_CE_35(35, "RFU CE 35"),
    RFU_CE_36(36, "RFU CE 36"),
    RFU_CE_37(37, "RFU CE 37"),
    RFU_CE_38(38, "RFU CE 38"),
    RFU_CE_39(39, "RFU CE 39"),
    RFU_CE_40(40, "RFU CE 40"),
    RFU_CE_41(41, "RFU CE 41"),
    RFU_CE_42(42, "RFU CE 42"),
    RFU_CE_43(43, "RFU CE 43"),
    RFU_CE_44(44, "RFU CE 44"),
    RFU_CE_45(45, "RFU CE 45"),
    RFU_CE_46(46, "RFU CE 46"),
    RFU_CE_47(47, "RFU CE 47"),
    RFU_CE_48(48, "RFU CE 48"),
    RFU_CE_49(49, "RFU CE 49"),
    RFU_CE_50(50, "RFU CE 50"),
    RFU_CE_51(51, "RFU CE 51"),
    RFU_CE_52(52, "RFU CE 52"),
    RFU_CE_53(53, "RFU CE 53"),
    RFU_CE_54(54, "RFU CE 54"),
    RFU_CE_55(55, "RFU CE 55"),
    RFU_CE_56(56, "RFU CE 56"),
    RFU_CE_57(57, "RFU CE 57"),
    RFU_CE_58(58, "RFU CE 58"),
    RFU_CE_59(59, "RFU CE 59"),
    RFU_CE_60(60, "RFU CE 60"),
    RFU_CE_61(61, "RFU CE 61"),
    RFU_CE_62(62, "RFU CE 62"),
    RFU_CE_63(63, "RFU CE 63"),
    ...
    KundenTypCode(final int value, final String stringRepresentation) {
        this(new INT1((short) value), stringRepresentation);
    }

    public static KundenTypCode of(final INT1 value) {
        for (final KundenTypCode terminalTypCode : values()) {
    ...
    public static final ReadDescription<KundenTypCode> READ_DESCRIPTION = stream -> of(INT1
            .READ_DESCRIPTION.read(stream));

    @Override
    public ReadDescription<KundenTypCode> getReadDescription() {
